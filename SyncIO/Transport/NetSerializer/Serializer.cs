...
namespace NetSerializer
{
    ...
    public class Serializer
    {
        ...
        /// <summary>
        /// Get a Dictionary&lt;Type, uint&gt; containing a mapping of all the serializer's Types to TypeIDs
        /// </summary>
        ...
        {
            if (!m_runtimeTypeMap.TryGetValue(type, out TypeData data) || data.CanCallDirect == false)
