namespace TaskManagerServerPlugin
{
    using System;
    ...
    using TaskManagerServerPlugin.UI.Forms;
        ...
        public void OnPluginReady()
        {
            ...
            var contextEntry = new ContextEntry
            {
                ...
                OnClick = (sender, e) =>
                {
                    ...
                    {
                        var taskManager = new TaskManager(_netHost, client.Value);
                        taskManager.Tag = client.Value.Id;
                        taskManager.Show();
                    }
                }
            };
