namespace ScreenCaptureServerPlugin
{
    ...
    static class Utils
    {
        ...
        public static void UpdateScreen(ref Bitmap screen, Bitmap newPartialScreen, Rectangle boundingBox)
        {
        ...
        public static void UpdateScreen(ref Bitmap screen, byte[] data)
        {
            // Unpack the data bytes
            UnpackScreenCaptureData(data, out Bitmap partial, out Rectangle bounds, out _);
